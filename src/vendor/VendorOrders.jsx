...
import { ShoppingBag, Banknote, Clock, PackageCheck, MapPin, Phone } from "lucide-react";
              ...
              {vendorOrders.map((order) => (
                <div key={order.id} className="bg-white rounded-[2rem] p-6 shadow-sm">
                  <div className="flex flex-col lg:flex-row lg:justify-between gap-6 mb-6">
                    <div>
                      ...
                      <div className="mt-4 space-y-2 text-gray-600">
                        ...
                        <p className="flex items-center gap-2">
                          <MapPin size={18} />
                          {order.customer?.city} - {order.customer?.location}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="border-t pt-5">
                    <h3 className="font-black mb-4">Your Items in this Order</h3>
                      ...
                      {order.vendorItems.map((item) => (
                        ...
                        >
                          ...
                          <p className="font-black">
                            GH₵ {Number(item.price || 0) * Number(item.quantity || 1)}
                          </p>
                        </div>
                      ))}
                    </div>
